...
from screenshot_helper import start_new_log, log_action # Updated import
...
def schedule_post(page: Page, tweet_text: str, item_time: datetime):
    ...
    try:
        ...
        # NOTE: If these SELECTOR_IDs change, this will break.
        # Original code used SELECTOR_4, SELECTOR_5, SELECTOR_6
        # These are usually dynamic. I am keeping them as per your instruction not to alter.
